...
export function ServiceTerm() {
  return (
    <div>
      <strong className={c.Highlight}>제 1조(목적)</strong>
      <span className={c.Numbering}>
        1.
        <p>
      ...
      <br />
      <strong className={c.Highlight}>제 2조(제공하는 서비스)</strong>
      ...
      <br />
      <strong className={c.Highlight}>제 3조(서비스의 중단 등)</strong>
      <span className={c.Numbering}>
        1.
        <p>
      ...
      <br />
      <strong className={c.Highlight}>제 4조(회원가입)</strong>
      <span className={c.Numbering}>
        1.
        <p>
      ...
      <br />
      <strong className={c.Highlight}>제 5조(회원탈퇴 및 자격상실 등)</strong>
      <span className={c.Numbering}>
        1.
      ...
      <br />
      <strong className={c.Highlight}>제 4조(이용자 및 회원의 의무)</strong>
      <span className={c.Numbering}>
        1.
        <p>
